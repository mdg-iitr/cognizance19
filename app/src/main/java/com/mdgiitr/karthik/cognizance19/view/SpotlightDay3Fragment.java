...
public class SpotlightDay3Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_spotlight_day3, container, false);

        recyclerView = view.findViewById(R.id.spotlight_day3_recyclerview);
        list = new ArrayList<>();
        adapter = new SpotlightAdapter(getContext(),list);

        SpotlightModel day3model1  = new SpotlightModel();
        day3model1.setCategory("Guest Lectures");
        ...
        day3model1.setGuestList(guestList);
        list.add(day3model1);


        SpotlightModel day3model2  = new SpotlightModel();
        day3model2.setCategory("Panel Discussion");
        List<SpotlightGuestModel> guestlist = new ArrayList<>();
        for (int i=0; i<5;i++){
            SpotlightGuestModel model = new SpotlightGuestModel();
        ...
        day3model2.setGuestList(guestlist);
        list.add(day3model2);
